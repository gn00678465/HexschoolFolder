    ...
    const actions: Common.StrategyActions = [
      ...
      [true, async () => {
        const newUser = await User.create({
          name: data.name,
          email: data.email,
          photo: 'https://images.unsplash.com/photo-1680372669294-570f598ce2e5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2072&q=80'
        });
        res.status(200).json({
          status: 'success',
          data: newUser
